...
- Return-to-JARVIS uses jarvis:// links or Shortcuts.
- App Intents expose supported in-app actions and must be compiled by Xcode or GitHub Actions before phone use.
- No private APIs.
- No jailbreak claims.
