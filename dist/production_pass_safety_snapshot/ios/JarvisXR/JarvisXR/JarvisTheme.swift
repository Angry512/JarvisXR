...
enum JarvisTheme {
    static let background = UIColor(red: 0.005, green: 0.008, blue: 0.010, alpha: 1.0)
    static let panel = UIColor(red: 0.04, green: 0.05, blue: 0.06, alpha: 1.0)
    static let panelRaised = UIColor(red: 0.065, green: 0.078, blue: 0.086, alpha: 1.0)
    static let panelBorder = UIColor(red: 0.22, green: 0.28, blue: 0.30, alpha: 1.0)
    static let text = UIColor(white: 0.92, alpha: 1.0)
    static let mutedText = UIColor(white: 0.60, alpha: 1.0)
    static let accent = UIColor(red: 0.22, green: 0.75, blue: 0.86, alpha: 1.0)
    static let accentHot = UIColor(red: 0.43, green: 0.95, blue: 1.0, alpha: 1.0)
    static let accentDim = UIColor(red: 0.10, green: 0.32, blue: 0.38, alpha: 1.0)
    static let warning = UIColor(red: 0.95, green: 0.72, blue: 0.28, alpha: 1.0)
    static let success = UIColor(red: 0.36, green: 0.83, blue: 0.62, alpha: 1.0)
