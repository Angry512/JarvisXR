...
python -m py_compile preview\windows_jarvis_preview\jarvis_preview.py tools\jarvis_interaction_test.py tools\jarvis_product_surface_test.py tools\jarvis_visual_state_export.py tools\audit_ipa.py
