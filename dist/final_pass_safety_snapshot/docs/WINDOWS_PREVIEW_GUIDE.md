...
5. Tap Orb once. State should become `JARVIS ready`.
6. Tap Orb again. State should become Listening.
7. Click `Speak: scan this`. State should move to Inspection after the endpoint.
8. Click `Keyboard`. Input should remain above the keyboard.
9. The help icon, orb, state line, input, and Send should remain visible in keyboard mode.
10. Click Look at this, Scan this, Read this, and Detect objects.
11. Detect objects should state that the object model is missing.
