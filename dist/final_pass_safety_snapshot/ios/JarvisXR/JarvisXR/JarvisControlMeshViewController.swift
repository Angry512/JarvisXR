...
final class JarvisControlMeshViewController: UIViewController {
    ...
    private func buildInterface() {
        ...
        textView.text = """
        JARVIS coordinates phone-level actions through official iOS layers.
        ...
        Boundaries:
        Hidden taps, lock screen control, SpringBoard hooks, background takeover, and arbitrary floating UI require system-level access and are not claimed in this build.
        """
